...
class Pelt():
    ...
    tortiebases = ['single', 'tabby', 'bengal', 'marbled', 'ticked', 'smoke', 'rosette', 'speckled', 'mackerel',
                'classic', 'sokoke', 'agouti', 'singlestripe', 'vsokoke']
    ...
    ginger_colours = ['CREAM', 'PALEGINGER', 'GOLDEN', 'GINGER', 'DARKGINGER', 'SIENNA', 'PEACHYELLOW', 'MOCHA', 'FOX', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'RICHGOLD', 'DUSTYPINK', 'GRASSY']
    black_colours = ['GREY', 'DARKGREY', 'GHOST', 'BLACK', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']
    white_colours = ['WHITE', 'PALEGREY', 'SILVER', 'CLOUD', 'ICE']
    brown_colours = ['LIGHTBROWN', 'LILAC', 'BROWN', 'GOLDEN-BROWN', 'DARKBROWN', 'CHOCOLATE', 'METALLICBRONZE', 'WALNUT', 'ESPRESSO', 'VANILLA', 'MUSHROOM', 'COFFEE', 'MOCCACCINO', 'PALEBROWN', 'IRONGREY']
    ...
    little_white = ['LITTLE', 'LIGHTTUXEDO', 'BUZZARDFANG', 'TIP', 'BLAZE', 'BIB', 'VEE', 'PAWS', 'BELLY', 'TAILTIP', 'TOES', 'BROKENBLAZE', 'LILTWO', 'SCOURGE', 'TOESTAIL', 'RAVENPAW', 'HONEY', 'LUNA', 'EXTRA', 'MUSTACHE', 'REVERSEHEART',
    ...
    mid_white = ['TUXEDO', 'FANCY', 'UNDERS', 'DAMIEN', 'SKUNK', 'MITAINE', 'SQUEAKS', 'STAR', 'WINGS', 'DIVA', 'SAVANNAH', 'FADESPOTS', 'BEARD', 'DAPPLEPAW', 'TOPCOVER', 'WOODPECKER', 'MISS', 'BOWTIE', 'VEST',
    ...
    high_white = ['ANY', 'ANYTWO', 'BROKEN', 'FRECKLES', 'RINGTAIL', 'HALFFACE', 'PANTSTWO', 'GOATEE', 'PRINCE', 'FAROFA', 'MISTER', 'PANTS', 'REVERSEPANTS', 'HALFWHITE', 'APPALOOSA', 'PIEBALD', 'CURVED', 'GLASS', 'MASKMANTLE', 'MAO', 'PAINTED', 'SHIBAINU', 'OWL', 'BUB', 'SPARROW',
    ...
    mostly_white = ['VAN', 'ONEEAR', 'LIGHTSONG', 'TAIL', 'HEART', 'MOORISH', 'APRON', 'CAPSADDLE', 'CHESTSPECK', 'BLACKSTAR', 'PETAL', 'HEARTTWO', 'PEBBLESHINE', 'BOOTS', 'COW', 'COWTWO',
    ...
    def check_and_convert(self, convert_dict):
        ...
        elif self.white_patches == 'BLACKPOINTMARK':
            self.white_patches = "BLACKSEALPOINT"
        elif self.white_patches == 'BLACKPANTS2':
            self.white_patches = 'BLACKPANTSTWO'
        elif self.white_patches == 'BLACKANY2':
            self.white_patches = 'BLACKANYTWO'
        elif self.white_patches == "BLACKVITILIGO2":
            self.white_patches = "BLACKVITILIGOTWO"
        elif self.white_patches == 'BROWNPOINTMARK':
            self.white_patches = "BROWNSEALPOINT"
        elif self.white_patches == 'BROWNPANTS2':
            self.white_patches = 'BROWNPANTSTWO'
        elif self.white_patches == 'BROWNANY2':
            self.white_patches = 'BROWNANYTWO'
        elif self.white_patches == "BROWNVITILIGO2":
            self.white_patches = "BROWNVITILIGOTWO"
        elif self.white_patches == 'GINGERPOINTMARK':
            self.white_patches = "GINGERSEALPOINT"
        elif self.white_patches == 'GINGERPANTS2':
            self.white_patches = 'GINGERPANTSTWO'
        elif self.white_patches == 'GINGERANY2':
            self.white_patches = 'GINGERANYTWO'
        elif self.white_patches == "GINGERVITILIGO2":
            self.white_patches = "GINGERVITILIGOTWO"
            
        if self.vitiligo == "VITILIGO2":
            self.vitiligo = "VITILIGOTWO"
        elif self.vitiligo == "BLACKVITILIGO2":
            self.vitiligo = "BLACKVITILIGOTWO"
        elif self.vitiligo == "BROWNVITILIGO2":
            self.vitiligo = "BROWNVITILIGOTWO"
        elif self.vitiligo == "GINGERVITILIGO2":
            self.vitiligo = "GINGERVITILIGOTWO"
        ...
        elif self.white_patches in ['SEPIAPOINT', 'MINKPOINT', 'SEALPOINT', 'BLACKSEPIAPOINT', 'BLACKMINKPOINT', 'BLACKSEALPOINT', 'BROWNSEPIAPOINT', 'BROWNMINKPOINT', 'BROWNSEALPOINT', 'GINGERSEPIAPOINT', 'GINGERMINKPOINT', 'GINGERSEALPOINT']:
    ...
    def white_patches_inheritance(self, parents: tuple):
        ...
        weights = [0, 0, 0, 0, 0, 0, 0, 0,]  # Same order as white_list
        for p_ in par_whitepatches:
            if p_ in Pelt.little_white:
                add_weights = (40, 20, 15, 5, 0, 0, 0, 0)
            elif p_ in Pelt.mid_white:
                add_weights = (10, 40, 15, 10, 0, 0, 0, 0)
            elif p_ in Pelt.high_white:
                add_weights = (15, 20, 40, 10, 1, 1, 1, 1)
            elif p_ in Pelt.mostly_white:
                add_weights = (5, 15, 20, 40, 5, 5, 5, 5)
            elif p_ == "FULLWHITE":
                add_weights = (0, 5, 15, 40, 10, 10, 10, 10)
            else:
                add_weights = (0, 0, 0, 0, 0, 0, 0, 0)
