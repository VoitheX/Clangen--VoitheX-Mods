...
class Pelt:
    ...
    tortiebases = ['single', 'tabby', 'bengal', 'marbled', 'ticked', 'smoke', 'rosette', 'speckled', 'mackerel',
                   'classic', 'sokoke', 'agouti', 'singlestripe', 'masked', 'sokokeV']
    ...
    tabbies = ["Tabby", "Ticked", "Mackerel", "Classic", "Sokoke", "Agouti", 'SokokeV']
    ...
    little_white = ['LITTLE', 'LIGHTTUXEDO', 'BUZZARDFANG', 'TIP', 'BLAZE', 'BIB', 'VEE', 'PAWS',
                   ...
                   'BLACKLITTLE', 'BLACKLIGHTTUXEDO', 'BLACKBUZZARDFANG', 'BLACKTIP', 'BLACKBLAZE', 'BLACKBIB', 'BLACKVEE',
                    'BLACKPAWS', 'BLACKBELLY', 'BLACKTAILTIP', 'BLACKTOES', 'BLACKBROKENBLAZE', 'BLACKLILTWO', 'BLACKSCOURGE',
                    'BLACKTOESTAIL', 'BLACKRAVENPAW', 'BLACKHONEY', 'BLACKLUNA', 'BLACKEXTRA', 'BLACKMUSTACHE', 'BLACKREVERSEHEART',
                    'BROWNLITTLE', 'BROWNLIGHTTUXEDO', 'BROWNBUZZARDFANG', 'BROWNTIP', 'BROWNBLAZE', 'BROWNBIB', 'BROWNVEE',
                    'BROWNPAWS', 'BROWNBELLY', 'BROWNTAILTIP', 'BROWNTOES', 'BROWNBROKENBLAZE', 'BROWNLILTWO', 'BROWNSCOURGE',
                    'BROWNTOESTAIL', 'BROWNRAVENPAW', 'BROWNHONEY', 'BROWNLUNA', 'BROWNEXTRA', 'BROWNMUSTACHE', 'BROWNREVERSEHEART',
                    'GINGERLITTLE', 'GINGERLIGHTTUXEDO', 'GINGERBUZZARDFANG', 'GINGERTIP', 'GINGERBLAZE', 'GINGERBIB',
                    'GINGERVEE', 'GINGERPAWS', 'GINGERBELLY', 'GINGERTAILTIP', 'GINGERTOES', 'GINGERBROKENBLAZE', 'GINGERLILTWO',
                    'GINGERSCOURGE', 'GINGERTOESTAIL', 'GINGERRAVENPAW', 'GINGERHONEY', 'GINGERLUNA', 'GINGEREXTRA', 'GINGERMUSTACHE', 'GINGERREVERSEHEART',
                    'BODYSTRIPE', 'BLACKBODYSTRIPE', 'BROWNBODYSTRIPE', 'GINGERBODYSTRIPE', 'SPRAYEDBODYSTRIPE', 'BLACKSPRAYEDBODYSTRIPE',
    ...
    mid_white = ['TUXEDO', 'FANCY', 'UNDERS', 'DAMIEN', 'SKUNK', 'MITAINE', 'SQUEAKS', 'STAR', 'WINGS',
                ...
                'BLACKTUXEDO', 'BLACKFANCY', 'BLACKUNDERS', 'BLACKDAMIEN', 'BLACKSKUNK', 'BLACKMITAINE', 'BLACKSQUEAKS',
                 'BLACKVOISTAR', 'BLACKWINGS', 'BLACKDIVA', 'BLACKSAVANNAH', 'BLACKFADESPOTS', 'BLACKBEARD', 'BLACKDAPPLEPAW',
                 'BLACKTOPCOVER', 'BLACKWOODPECKER', 'BLACKMISS', 'BLACKBOWTIE', 'BLACKVEST',
                 'BROWNTUXEDO', 'BROWNFANCY', 'BROWNUNDERS', 'BROWNDAMIEN', 'BROWNSKUNK', 'BROWNMITAINE', 'BROWNSQUEAKS',
                 'BROWNVOISTAR', 'BROWNWINGS', 'BROWNDIVA', 'BROWNSAVANNAH', 'BROWNFADESPOTS', 'BROWNBEARD', 'BROWNDAPPLEPAW',
                 'BROWNTOPCOVER', 'BROWNWOODPECKER', 'BROWNMISS', 'BROWNBOWTIE', 'BROWNVEST',
                 'GINGERTUXEDO', 'GINGERFANCY', 'GINGERUNDERS', 'GINGERDAMIEN', 'GINGERSKUNK', 'GINGERMITAINE', 'GINGERSQUEAKS',
                 'GINGERVOISTAR', 'GINGERWINGS', 'GINGERDIVA', 'GINGERSAVANNAH', 'GINGERFADESPOTS', 'GINGERBEARD', 'GINGERDAPPLEPAW',
                 'GINGERTOPCOVER', 'GINGERWOODPECKER', 'GINGERMISS', 'GINGERBOWTIE', 'GINGERVEST'
                 ]
    high_white = ['ANY', 'ANYTWO', 'BROKEN', 'FRECKLES', 'RINGTAIL', 'HALFFACE', 'PANTSTWO',
                  ...
                  'BLACKANY', 'BLACKANYTWO', 'BLACKBROKEN', 'BLACKFRECKLES', 'BLACKRINGTAIL', 'BLACKHALFFACE',
                  'BLACKPANTSTWO', 'BLACKGOATEE', 'BLACKPRINCE', 'BLACKFAROFA', 'BLACKMISTER', 'BLACKPANTS',
                  'BLACKREVERSEPANTS', 'BLACKHALFWHITE', 'BLACKAPPALOOSA', 'BLACKPIEBALD', 'BLACKCURVED',
                  'BLACKGLASS', 'BLACKMASKMANTLE', 'BLACKMAO', 'BLACKPAINTED', 'BLACKSHIBAINU', 'BLACKOWL', 'BLACKBUB', 'BLACKSPARROW',
                  'BROWNANY', 'BROWNANYTWO', 'BROWNBROKEN', 'BROWNFRECKLES', 'BROWNRINGTAIL', 'BROWNHALFFACE',
                  'BROWNPANTSTWO', 'BROWNGOATEE', 'BROWNPRINCE', 'BROWNFAROFA', 'BROWNMISTER', 'BROWNPANTS',
                  'BROWNREVERSEPANTS', 'BROWNHALFWHITE', 'BROWNAPPALOOSA', 'BROWNPIEBALD', 'BROWNCURVED',
                  'BROWNGLASS', 'BROWNMASKMANTLE', 'BROWNMAO', 'BROWNPAINTED', 'BROWNSHIBAINU', 'BROWNOWL', 'BROWNBUB', 'BROWNSPARROW',
                  'GINGERANY', 'GINGERANYTWO', 'GINGERBROKEN', 'GINGERFRECKLES', 'GINGERRINGTAIL', 'GINGERHALFFACE',
                  'GINGERPANTSTWO', 'GINGERGOATEE', 'GINGERPRINCE', 'GINGERFAROFA', 'GINGERMISTER', 'GINGERPANTS',
                  'GINGERREVERSEPANTS', 'GINGERHALFWHITE', 'GINGERAPPALOOSA', 'GINGERPIEBALD', 'GINGERCURVED',
                  'GINGERGLASS', 'GINGERMASKMANTLE', 'GINGERMAO', 'GINGERPAINTED', 'GINGERSHIBAINU', 'GINGEROWL', 'GINGERBUB', 'GINGERSPARROW',
    ...
    mostly_white = ['VAN', 'ONEEAR', 'LIGHTSONG', 'TAIL', 'HEART', 'MOORISH', 'APRON', 'CAPSADDLE',
                    ...
                    'BLACKVAN', 'BLACKONEEAR', 'BLACKLIGHTSONG', 'BLACKTAIL', 'BLACKHEART', 'BLACKMOORISH', 'BLACKAPRON',
                    'BLACKCAPSADDLE', 'BLACKCHESTSPECK', 'BLACKVOIBLACKSTAR', 'BLACKPETAL', 'BLACKHEARTTWO', 'BLACKPEBBLESHINE', 'BLACKBOOTS', 'BLACKCOW', 'BLACKCOWTWO',
                    'BROWNVAN', 'BROWNONEEAR', 'BROWNLIGHTSONG', 'BROWNTAIL', 'BROWNHEART', 'BROWNMOORISH', 'BROWNAPRON',
                    'BROWNCAPSADDLE', 'BROWNCHESTSPECK', 'BROWNVOIBLACKSTAR', 'BROWNPETAL', 'BROWNHEARTTWO', 'BROWNPEBBLESHINE', 'BROWNBOOTS', 'BROWNCOW', 'BROWNCOWTWO',
                    'GINGERVAN', 'GINGERONEEAR', 'GINGERLIGHTSONG', 'GINGERTAIL', 'GINGERHEART', 'GINGERMOORISH',
                    'GINGERAPRON', 'GINGERCAPSADDLE', 'GINGERCHESTSPECK', 'GINGERVOIBLACKSTAR', 'GINGERPETAL', 'GINGERHEARTTWO', 'GINGERPEBBLESHINE', 'GINGERBOOTS', 'GINGERCOW', 'GINGERCOWTWO',
                    'REVERSEBODYSPRITE', 'BLACKREVERSEBODYSPRITE', 'BROWNREVERSEBODYSPRITE', 'GINGERREVERSEBODYSPRITE',
