...
class Sprites:
    ...
    def load_all(self):
        ...
        for x in [
            ...
            'sokokevvoithex', 'speckledtabbyvoithex', 'stainvoithex',
            'sokokevvoithexpelts', 'singlevoithexpelts', 'tabbyvoithexpelts', 'marbledvoithexpelts', 'rosettevoithexpelts', 'smokevoithexpelts', 'tickedvoithexpelts', 'speckledvoithexpelts', 'bengalvoithexpelts',
            'mackerelvoithexpelts', 'classicvoithexpelts', 'sokokevoithexpelts', 'agoutivoithexpelts', 'singlestripevoithexpelts', 'speckledtabbyvoithexpelts', 'stainvoithexpelts', 'maskedvoithexpelts',
        ]:
        ...
        color_categories = [
            ['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL',
             'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY'],
            ['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY',
             'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET'],
        ]

        color_types = [
            'singlevoithexpelts', 'tabbyvoithexpelts', 'marbledvoithexpelts', 'rosettevoithexpelts', 'smokevoithexpelts', 'tickedvoithexpelts', 'speckledvoithexpelts', 'bengalvoithexpelts',
            'mackerelvoithexpelts', 'classicvoithexpelts', 'sokokevoithexpelts', 'sokokevvoithexpelts', 'agoutivoithexpelts', 'singlestripevoithexpelts', 'speckledtabbyvoithexpelts', 'stainvoithexpelts', 'maskedvoithexpelts'
        ]

        for row, colors in enumerate(color_categories):
            for col, color in enumerate(colors):
                for color_type in color_types:
                    self.make_group(color_type, (col, row), f'{color_type[:-12]}{color}')
