...
for a, i in enumerate(['FULLBLACK', 'BLACKANY', 'BLACKTUXEDO', 'BLACKLITTLE', 'BLACKCOLOURPOINT', 'BLACKVAN', 'BLACKANYTWO',
    'BLACKMOON', 'BLACKPHANTOM', 'BLACKPOWDER', 'BLACKBLEACHED', 'BLACKSAVANNAH', 'BLACKFADESPOTS', 'BLACKPEBBLESHINE']):
    sprites.make_group('blackpatches', (a, 0), f'white{i}')
for a, i in enumerate(['BLACKEXTRA', 'BLACKONEEAR', 'BLACKBROKEN', 'BLACKLIGHTTUXEDO', 'BLACKBUZZARDFANG', 'BLACKRAGDOLL', 
    'BLACKLIGHTSONG', 'BLACKVITILIGO', 'BLACKVOIBLACKSTAR', 'BLACKPIEBALD', 'BLACKCURVED', 'BLACKPETAL', 'BLACKSHIBAINU', 'BLACKOWL']):
    sprites.make_group('blackpatches', (a, 1), f'white{i}')
for a, i in enumerate(['BLACKTIP', 'BLACKFANCY', 'BLACKFRECKLES', 'BLACKRINGTAIL', 'BLACKHALFFACE', 'BLACKPANTSTWO', 'BLACKGOATEE', 'BLACKVITILIGOTWO',
    'BLACKPAWS', 'BLACKMITAINE', 'BLACKBROKENBLAZE', 'BLACKSCOURGE', 'BLACKDIVA', 'BLACKBEARD']):
    sprites.make_group('blackpatches', (a, 2), f'white{i}')
for a, i in enumerate(['BLACKTAIL', 'BLACKBLAZE', 'BLACKPRINCE', 'BLACKBIB', 'BLACKVEE', 'BLACKUNDERS', 'BLACKHONEY',
    'BLACKFAROFA', 'BLACKDAMIEN', 'BLACKMISTER', 'BLACKBELLY', 'BLACKTAILTIP', 'BLACKTOES', 'BLACKTOPCOVER']):
    sprites.make_group('blackpatches', (a, 3), f'white{i}')
for a, i in enumerate(
    ...
    sprites.make_group('blackpatches', (a, 4), f'white{i}')
for a, i in enumerate(['BLACKHEART', 'BLACKLILTWO', 'BLACKGLASS', 'BLACKMOORISH', 'BLACKSEPIAPOINT', 'BLACKMINKPOINT', 'BLACKSEALPOINT',
    'BLACKMAO', 'BLACKLUNA', 'BLACKCHESTSPECK', 'BLACKWINGS', 'BLACKPAINTED', 'BLACKHEARTTWO', 'BLACKWOODPECKER']):
    sprites.make_group('blackpatches', (a, 5), f'white{i}')
for a, i in enumerate(['BLACKBOOTS', 'BLACKMISS', 'BLACKCOW', 'BLACKCOWTWO', 'BLACKBUB', 'BLACKBOWTIE', 'BLACKMUSTACHE', 'BLACKREVERSEHEART', 'BLACKSPARROW', 'BLACKVEST']):
    sprites.make_group('blackpatches', (a, 6), 'white' + i)

for a, i in enumerate(['FULLBROWN', 'BROWNANY', 'BROWNTUXEDO', 'BROWNLITTLE', 'BROWNCOLOURPOINT', 'BROWNVAN', 'BROWNANYTWO',
    'BROWNMOON', 'BROWNPHANTOM', 'BROWNPOWDER', 'BROWNBLEACHED', 'BROWNSAVANNAH', 'BROWNFADESPOTS', 'BROWNPEBBLESHINE']):
    sprites.make_group('brownpatches', (a, 0), f'white{i}')
for a, i in enumerate(['BROWNEXTRA', 'BROWNONEEAR', 'BROWNBROKEN', 'BROWNLIGHTTUXEDO', 'BROWNBUZZARDFANG', 'BROWNRAGDOLL', 
    'BROWNLIGHTSONG', 'BROWNVITILIGO', 'BROWNVOIBLACKSTAR', 'BROWNPIEBALD', 'BROWNCURVED', 'BROWNPETAL', 'BROWNSHIBAINU', 'BROWNOWL']):
    sprites.make_group('brownpatches', (a, 1), f'white{i}')
for a, i in enumerate(['BROWNTIP', 'BROWNFANCY', 'BROWNFRECKLES', 'BROWNRINGTAIL', 'BROWNHALFFACE', 'BROWNPANTSTWO', 'BROWNGOATEE', 'BROWNVITILIGOTWO',
    'BROWNPAWS', 'BROWNMITAINE', 'BROWNBROKENBLAZE', 'BROWNSCOURGE', 'BROWNDIVA', 'BROWNBEARD']):
    sprites.make_group('brownpatches', (a, 2), f'white{i}')
for a, i in enumerate(['BROWNTAIL', 'BROWNBLAZE', 'BROWNPRINCE', 'BROWNBIB', 'BROWNVEE', 'BROWNUNDERS', 'BROWNHONEY',
    'BROWNFAROFA', 'BROWNDAMIEN', 'BROWNMISTER', 'BROWNBELLY', 'BROWNTAILTIP', 'BROWNTOES', 'BROWNTOPCOVER']):
    sprites.make_group('brownpatches', (a, 3), f'white{i}')
for a, i in enumerate(
    ...
    sprites.make_group('brownpatches', (a, 4), f'white{i}')
for a, i in enumerate(['BROWNHEART', 'BROWNLILTWO', 'BROWNGLASS', 'BROWNMOORISH', 'BROWNSEPIAPOINT', 'BROWNMINKPOINT', 'BROWNSEALPOINT',
    'BROWNMAO', 'BROWNLUNA', 'BROWNCHESTSPECK', 'BROWNWINGS', 'BROWNPAINTED', 'BROWNHEARTTWO', 'BROWNWOODPECKER']):
    sprites.make_group('brownpatches', (a, 5), f'white{i}')
for a, i in enumerate(['BROWNBOOTS', 'BROWNMISS', 'BROWNCOW', 'BROWNCOWTWO', 'BROWNBUB', 'BROWNBOWTIE', 'BROWNMUSTACHE', 'BROWNREVERSEHEART', 'BROWNSPARROW', 'BROWNVEST']):
    sprites.make_group('brownpatches', (a, 6), 'white' + i)

for a, i in enumerate(['FULLGINGER', 'GINGERANY', 'GINGERTUXEDO', 'GINGERLITTLE', 'GINGERCOLOURPOINT', 'GINGERVAN', 'GINGERANYTWO',
    'GINGERMOON', 'GINGERPHANTOM', 'GINGERPOWDER', 'GINGERBLEACHED', 'GINGERSAVANNAH', 'GINGERFADESPOTS', 'GINGERPEBBLESHINE']):
    sprites.make_group('gingerpatches', (a, 0), f'white{i}')
for a, i in enumerate(['GINGEREXTRA', 'GINGERONEEAR', 'GINGERBROKEN', 'GINGERLIGHTTUXEDO', 'GINGERBUZZARDFANG', 'GINGERRAGDOLL', 
    'GINGERLIGHTSONG', 'GINGERVITILIGO', 'GINGERVOIBLACKSTAR', 'GINGERPIEBALD', 'GINGERCURVED', 'GINGERPETAL', 'GINGERSHIBAINU', 'GINGEROWL']):
    sprites.make_group('gingerpatches', (a, 1), f'white{i}')
for a, i in enumerate(['GINGERTIP', 'GINGERFANCY', 'GINGERFRECKLES', 'GINGERRINGTAIL', 'GINGERHALFFACE', 'GINGERPANTSTWO', 'GINGERGOATEE', 'GINGERVITILIGOTWO',
    'GINGERPAWS', 'GINGERMITAINE', 'GINGERBROKENBLAZE', 'GINGERSCOURGE', 'GINGERDIVA', 'GINGERBEARD']):
    sprites.make_group('gingerpatches', (a, 2), f'white{i}')
for a, i in enumerate(['GINGERTAIL', 'GINGERBLAZE', 'GINGERPRINCE', 'GINGERBIB', 'GINGERVEE', 'GINGERUNDERS', 'GINGERHONEY',
    'GINGERFAROFA', 'GINGERDAMIEN', 'GINGERMISTER', 'GINGERBELLY', 'GINGERTAILTIP', 'GINGERTOES', 'GINGERTOPCOVER']):
    sprites.make_group('gingerpatches', (a, 3), f'white{i}')
for a, i in enumerate(
    ...
    sprites.make_group('gingerpatches', (a, 4), f'white{i}')
for a, i in enumerate(['GINGERHEART', 'GINGERLILTWO', 'GINGERGLASS', 'GINGERMOORISH', 'GINGERSEPIAPOINT', 'GINGERMINKPOINT', 'GINGERSEALPOINT',
    'GINGERMAO', 'GINGERLUNA', 'GINGERCHESTSPECK', 'GINGERWINGS', 'GINGERPAINTED', 'GINGERHEARTTWO', 'GINGERWOODPECKER']):
    sprites.make_group('gingerpatches', (a, 5), f'white{i}')
for a, i in enumerate(['GINGERBOOTS', 'GINGERMISS', 'GINGERCOW', 'GINGERCOWTWO', 'GINGERBUB', 'GINGERBOWTIE', 'GINGERMUSTACHE', 'GINGERREVERSEHEART', 'GINGERSPARROW', 'GINGERVEST']):
    sprites.make_group('gingerpatches', (a, 6), 'white' + i)

for a, i in enumerate(['BODYSTRIPE', 'BLACKBODYSTRIPE', 'BROWNBODYSTRIPE', 'GINGERBODYSTRIPE', 'TIGERBODYSTRIPE', 'BLACKTIGERBODYSTRIPE', 'BROWNTIGERBODYSTRIPE', 'GINGERTIGERBODYSTRIPE', 'SPRAYEDBODYSTRIPE', 'BLACKSPRAYEDBODYSTRIPE', 'BROWNSPRAYEDBODYSTRIPE', 'GINGERSPRAYEDBODYSTRIPE']):
    sprites.make_group('voithexpatches', (a, 0), f'white{i}')
for a, i in enumerate(['REVERSEBODYSPRITE', 'BLACKREVERSEBODYSPRITE', 'BROWNREVERSEBODYSPRITE', 'GINGERREVERSEBODYSPRITE', 'REVERSETIGERBODYSPRITE', 'BLACKREVERSETIGERBODYSPRITE', 'BROWNREVERSETIGERBODYSPRITE', 'GINGERREVERSETIGERBODYSPRITE', 'REVERSELEOPARDBODYSPRITE', 'BLACKREVERSELEOPARDBODYSPRITE', 'BROWNREVERSELEOPARDBODYSPRITE', 'GINGERREVERSELEOPARDBODYSPRITE']):
    sprites.make_group('voithexpatches', (a, 1), f'white{i}')
# single (solid)
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltssingle', (a, 0), f'single{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltssingle', (a, 1), f'single{i}')
# tabby
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltstabby', (a, 0), f'tabby{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltstabby', (a, 1), f'tabby{i}')
# marbled
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltsmarbled', (a, 0), f'marbled{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltsmarbled', (a, 1), f'marbled{i}')
# rosette
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltsrosette', (a, 0), f'rosette{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltsrosette', (a, 1), f'rosette{i}')
# smoke
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltssmoke', (a, 0), f'smoke{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltssmoke', (a, 1), f'smoke{i}')
# ticked
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltsticked', (a, 0), f'ticked{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltsticked', (a, 1), f'ticked{i}')
# speckled
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltsspeckled', (a, 0), f'speckled{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltsspeckled', (a, 1), f'speckled{i}')
# bengal
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltsbengal', (a, 0), f'bengal{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltsbengal', (a, 1), f'bengal{i}')
# mackerel
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltsmackrel', (a, 0), f'mackerel{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltsmackrel', (a, 1), f'mackerel{i}')
# classic
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltsclassic', (a, 0), f'classic{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltsclassic', (a, 1), f'classic{i}')
# sokoke
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltssokoke', (a, 0), f'sokoke{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltssokoke', (a, 1), f'sokoke{i}')
# agouti
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltsagouti', (a, 0), f'agouti{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltsagouti', (a, 1), f'agouti{i}')
# singlestripe
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
    sprites.make_group('voithexpeltssinglestripe', (a, 0), f'singlestripe{i}')
for a, i in enumerate(['CLOUD', 'VAMPIRE', 'DOVE', 'GRAVEL', 'SLATEGREY', 'ICE', 'CADETBLUE', 'OLDLAVENDER', 'COMET', 'MIDGREY', 'IRONGREY', 'DUST', 'VIOLET', 'DARKVIOLET', 'BLUEVIOLET', 'CHARCOAL', 'ASH', 'PALEVIOLET']):
    sprites.make_group('voithexpeltssinglestripe', (a, 1), f'singlestripe{i}')
# VoitheX Sokoke
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
    sprites.make_group('voithexsokoke', (a, 0), f'vsokoke{i}')
for a, i in enumerate(['CREAM', 'PALEGINGER', 'GOLDEN', 'GINGER', 'DARKGINGER', 'SIENNA']):
    sprites.make_group('voithexsokoke', (a, 1), f'vsokoke{i}')
for a, i in enumerate(['LIGHTBROWN', 'LILAC', 'BROWN', 'GOLDEN-BROWN', 'DARKBROWN', 'CHOCOLATE']):
    sprites.make_group('voithexsokoke', (a, 2), f'vsokoke{i}')
for a, i in enumerate(['PEACHYELLOW', 'MOCHA', 'METALLICBRONZE', 'WALNUT', 'FOX', 'ESPRESSO', 'PALEORANGE', 'PALECARMINE', 'CARAMEL', 'SIENNA2', 'VANILLA', 'MUSHROOM', 'COFFEE', 'RICHGOLD', 'MOCCACCINO', 'PALEBROWN', 'DUSTYPINK', 'GRASSY']):
